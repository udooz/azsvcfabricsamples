...
namespace WishUIService
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("WishUIServiceType", context => new WebHostingService(context, "SecServiceEndpoint")).GetAwaiter().GetResult();
        ...
        internal sealed class WebHostingService : StatelessService, ICommunicationListener
        {
            ...
            protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
            {
                return new[] {
                    ...
                    //new ServiceInstanceListener(serviceContext => new WebHostingService(serviceContext, "SecServiceEndpoint"))
                };
            }
