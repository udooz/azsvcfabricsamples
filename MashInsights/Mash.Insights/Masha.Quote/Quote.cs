...
namespace Masha.Quote
{
    ...
    internal class Quote : Actor, IQuote
    {
        ...
        public Quote(ActorService actorService, ActorId actorId)
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> IQuote.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task IQuote.SetCountAsync(int count, CancellationToken cancellationToken)
        {
